...
import '../somali/manifesto/ፕሮግራም.dart';
import '../somali/መተዳደሪያ/መተዳደሪያደንብ.dart';
import '../somali/ፕሮግራም/mawcha.dart';
import 'afar.dart';
import 'oromia.dart';
...
class somali extends StatefulWidget {
  const somali({super.key});

  @override
  State<somali> createState() => _somaliState();
}

class _somaliState extends State<somali> {
  @override
